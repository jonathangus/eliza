...
import { default as createRabbiTraderPlugin } from "@elizaos/plugin-rabbi-trader";
...
export async function initializeClients(
    ...
    if (clientTypes.includes("lens")) {
        console.log("STARTING LENS IN AGENT:");
...
async function startAgent(
    ...
    try {
        ...
        // const rabbiPlugin = await createRabbiTraderPlugin((key: string) => {
        //     if (key === "TWITTER_ENABLED") {
        //         return "false";
        //     }
        ...
        // if (rabbiPlugin) {
        //     runtime.plugins.push(rabbiPlugin);

        //     rabbiPlugin.actions?.forEach((item) => {
        //         runtime.registerAction(item);
        //     });

        //     rabbiPlugin.evaluators?.forEach((item) => {
        //         runtime.registerEvaluator(item);
        //     });

        //     rabbiPlugin.services?.forEach((item) => {
        //         runtime.registerService(item);
        //     });

        //     rabbiPlugin.providers?.forEach((item) => {
        //         runtime.registerContextProvider(item);
        //     });
        // }
